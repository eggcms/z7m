...
@if($meta_description)
    {{ $meta_description }}
@else
	ทีเด็ดคลับดอทคอม ข้อมูลการวิเคราะห์ สเต็ปบอลสเต็ป ประจำวัน
@endif
@endsection
...
<div class="api-tded">
    <div class="container bg-con">
        <div class="row">
            <div class="col-12">
                <div class="api py-3">
                    <h3 style="font-size:20px; margin: 10px 0 5px 0; color:#eeeeee;">ราคาบอลสเต็ป ทรรศนะบอลสเต็ป, ฟันธงบอลสเต็ป</h3>
                    {{ballstep($objs)}}
                </div>
            </div>
        </div>
